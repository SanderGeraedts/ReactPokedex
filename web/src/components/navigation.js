...
// Hieronder een voorbeeld hoe ik het deed op mijn persoonlijke site:
/*
import { Link } from "gatsby"
...
const Navigation = () => {
  ...
  // Runs the setActiveImage function on Mount
  useEffect(() => {
    setActiveImage("/about-me")
    setActiveImage("/posts")
    setActiveImage("/portfolio")
    setActiveImage("/contact")
  }, []) // <- That empty "dependancy" array ensures it only runs once on mount
